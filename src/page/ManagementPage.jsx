...
import ManagementChart from '../components/main/accountManagement/ManagementChart';
...
const AccountPage = () => {
  ...
  return (
    <Container>
      ...
      <ManagementChart account={renderData([...toydata, ...addRow])} addRow={addRow} page={page} />
      <PaginationContainer>
        <GDSCPagination
